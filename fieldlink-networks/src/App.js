...
const Connectivity = () => (
  <section id="connectivity" className="section-pad" style={{ padding: "120px clamp(20px,4vw,60px)", background: `linear-gradient(180deg, ${C.bg} 0%, ${C.bgLight} 50%, ${C.bg} 100%)` }}>
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      <FadeIn>
        <div style={{ textAlign: "center", marginBottom: 80 }}>
      ...
      <FadeIn>
        <div className="bond-pad" style={{ background: "rgba(255,255,255,0.02)", border: `1px solid ${C.borderDim}`, borderRadius: 24, padding: 48, marginBottom: 48 }}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div className="bond-result" style={{ display: "inline-flex", alignItems: "center", gap: 12, background: `linear-gradient(135deg, rgba(0,194,255,0.1), rgba(0,120,212,0.1))`, border: "1px solid rgba(0,194,255,0.25)", borderRadius: 16, padding: "20px 40px" }}>
      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          .bond-pad { padding: 24px !important; }
          .bond-result { padding: 16px 24px !important; }
